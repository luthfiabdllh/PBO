...
public class Main {
    public static void main(String[] args) {
        ...
        Player P1 = new Player(50, 10, "Luthfi");
        Merchant merchant1 = new Merchant(30,20, listItem);
        Zombie zombie1 = new Zombie(30, 5, Types.MELEE);
        Zombie zombie2 = new Zombie(15, 5, Types.RANGED);
